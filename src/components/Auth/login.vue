...
<!-- <div >
  <div class="login-form bg-gray-300 border border-2 border-purple-900 rounded-lg mt-10">
    <form action="#" @submit.prevent="login">

      <div class="form-control m-5">
        <label for="email">Email</label>
        <input type="email" name="email" id="email" class="login-input border border-2 border-purple-900
         rounded-lg mb-4" placeholder="Email" v-model="email" >
      </div>

      <div class="form-control  m-5">
        <label for="password">Password</label>
        <input type="password" name="password" id="password" class="login-input border border-2 border-purple-900 
        rounded-lg"  placeholder="password" v-model="password">
      </div>

      <div class="form-control mb-4 ml-20 mr-20">
        <button type="submit" class="btn-submit bg-purple-900 text-xl font-bold text-gray-100 
        border border-2 border-purple-900 rounded-lg hover:bg-purple-300">Login</button>
      </div>
