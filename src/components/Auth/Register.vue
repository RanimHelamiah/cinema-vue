                     ...
                     <div class="flex -mx-3">
                        <div class="form-control w-1/2 px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input type="password" class="login-input bg-gray-100 w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border border-2 border-purple-900 
                                 outline-none focus:border-purple-500" 
                                 name="password" id="password" placeholder="Number" v-model="password">
                            </div>
                        </div>
                        <div class="form-control w-1/2 px-3 mb-5">
                            <label for="" class="text-sm font-semibold px-1">password_confirmation</label>
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center">
                                  <i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                <input type="password" class="login-input bg-gray-100 w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border border-2 border-purple-900 
                                 outline-none focus:border-purple-500"
                                 name="password_confirmation" id="password_confirmation" v-model="password_confirmation">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <button  type="submit" class="btn-submit block w-full max-w-xs mx-auto bg-purple-900 hover:bg-purple-500 
                            focus:bg-purple-700 text-gray-100 rounded-lg px-3 py-3 font-semibold border border-2 border-purple-900">
                            REGISTER NOW</button>
                            
                            <a  class="underline text-sm text-gray-600 hover:text-gray-900 pl-10 " href="/login">
                              Already registered?
                            </a>
                        </div>
                    </div>
