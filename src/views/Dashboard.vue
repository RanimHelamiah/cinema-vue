  ...
  <App>
   <div class="dashboard p-4">
    <nav class="flex" aria-label="Breadcrumb">
      <ol class="inline-flex items-center space-x-1 md:space-x-3">
        <li class="inline-flex items-center">
          <a
            href="#"
            class="inline-flex items-center text-sm font-medium text-purple-700 hover:text-purple-900 dark:text-gray-400 dark:hover:text-white"
          >
            <svg
              class="mr-2 w-4 h-4"
              fill="currentColor"
    ...
    <div class="mt-5 w-full">
      <h1 class="text-2xl text-purple-900 dark:text-gray-200 font-medium">
        Dashboard
      </h1>
    </div>
    <!-- grid wrapper card -->
    ...
    >
      <!-- card  -->
      <div
        class="card bg-gray-100 dark:bg-purple-800 w-full rounded-md p-5 shadow flex"
      >
        ...
        <div class="block p-2 w-full">
          <p class="font-semibold text-purple-900 dark:text-gray-200 text-xl">
            Rp.2 300 908
          </p>
          <h2 class="font-normal text-purple-400 text-md mt-1">Best Selling Movies for Tickets.</h2>
        </div>
      ...
      >
        ...
        <div class="block p-2 w-full">
          ...
          <h2 class="font-normal text-purple-400 text-md mt-1">Lowest Selling Movies for Tickets.</h2>
        </div>
      </div>
      <!-- end card -->
      <div
      ...
      >
        ...
        <div class="block p-2 w-full">
          ...
          <h2 class="font-normal text-purple-400 text-md mt-1">
            Total Users
          </h2>
        </div>
      </div>
      ...
      >
        ...
        <div class="block p-2 w-full">
          ...
          <h2 class="font-normal text-purple-400 text-md mt-1">Total Sales</h2>
        </div>
      </div>
      <!-- end card -->
    </div>
    ...
    <div class="mt-4 lg:flex block lg:gap-2">
      <div
        class="bg-gray-100 dark:bg-purple-800 p-5 w-full rounded-md box-border shadow"
      >
        <!-- <h2 class="font-bold text-lg text-purple-800 dark:text-gray-200">
          Ticket Sales
        </h2>
    ...
    <div class="mt-2 lg:flex block lg:gap-2">
      <div
        class="mt-2 bg-gray-100 dark:bg-purple-800 p-5 w-full rounded-md box-border shadow"
      >
        ...
        <div class="wrapper-chart mt-5">
          ...
          <div class="wrapper-button mt-3">
            <select
              name=""
              id=""
              class="dark:bg-purple-800 dark:hover:bg-gray-700 border-gray-200 dark:border-gray-300 border max-w-lg px-4 py-3 block rounded-md text-gray-500 dark:text-gray-400"
            >
    ...
    >
      ...
      <div class="wrapping-table mt-10">
        ...
        >
          ...
          <tbody>
            <tr
              class="bg-gray-100 border-b dark:bg-purple-800 dark:border-gray-700 odd:bg-gray-100 even:bg-gray-50"
